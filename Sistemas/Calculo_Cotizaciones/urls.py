...
from .views import home, creacion_cliente, agregar_cliente, registrar, dashboards, lista_historial, crear_plancha, custom_login_view, eliminar_plancha, editar_plancha, lista_planchas, mantencion_planchas_form, crear_parametro, mantencion_parametros_form, cotizacion_manual, procesar_datos, calculo_de_precio, editar_parametro, eliminar_parametro, lista_parametros
